import { ComplaintItem } from '@/types/types.jsx';
...
const Complaints = () => {
  ...
  return (
    <div className=" ">
            <div className="w-full col-span-1 relative lg:h-[52vh] h-[50vh] m-auto px4 pt-4 bg-white rounded-lg overflow-scroll">
                <ul>
                    {COMPLAINT_ITEMS.map((item, index) => (
                        <li key={index} className='flex flex-col gap-2 mb-4 items-center'>
