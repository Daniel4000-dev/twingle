...
export default function Home() {
  return (
    <div className="flex flex-row items-center justify-between w-screen">
      <div className="w-[20vw] min-h-screen bg-black text-white">
      ...
      <div className="w-[80vw] min-h-screen flex flex-1 flex-col items-center bg-gray-100 text-black">
        <div className="w-[76vw] mt-4">
          ...
          <div className="flex gap-4 justify-between mb-4">
            <div className="w-[53vw] bg-white rounded-lg">p</div>
                ...
                <div className="flex flex-col gap-2 mb-4 items-center">
                  <div className="w-[21vw]  rounded-lg shadow-sm shadow-purple-200">
                    ...
                    <div className="flex justify-around m-2 pt-1 pb-1">
                      <h2>
                        552 <span className="text-sm">reports</span>
                      </h2>
                      <p>--</p>
          ...
          <div className="bg-white h-[23vh] rounded-lg flex flex-col items-center">
            <div className='w-[72vw] mt-2 mb-2'>
              <h2>47 pending disputes</h2>
            </div>
            <div className="w-[72vw] h-[17vh] overflow-auto">
            <div className="mb-2 bg-gray-100 flex items-center justify-between w-[72vw] p-3 rounded-lg">
              <div>
              <h2 className="text-">
                Chiamaka <span className='text-sm text-gray-300'>chiamaka@gmail.com</span>
              </h2>
              <h2 className="text-sm">
                Hello there, i am having difficulty setting up my account. My
                password keeps being declined each time i add it to the form.
                what...
              </h2>
              </div>
            ...
            <div className="bg-gray-100 flex items-center justify-between w-[72vw] p-3 rounded-lg">
              <div>
              <h2 className="text-">
                Chiamaka <span className='text-sm text-gray-300'>chiamaka@gmail.com</span>
              </h2>
